...
public class DateKit {
    ...
    public static boolean isToday(Calendar date) {
        ...
        boolean result = true;
        result &= date.get(Calendar.YEAR) == now.get(Calendar.YEAR);
        result &= date.get(Calendar.MONTH) == now.get(Calendar.MONTH);
        result &= date.get(Calendar.DATE) == now.get(Calendar.DATE);
        return result;
    }
